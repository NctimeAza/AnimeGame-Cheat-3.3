...
DO_API(0x28656C0, 0x0, int, il2cpp_init, (const char* domain_name)); // a1
DO_API(0x028659D0, 0x0, void, il2cpp_shutdown, ()); // a1[1]
DO_API(0x02865930, 0x0, void, il2cpp_set_config_dir, (const char* config_path)); // a1[2]
DO_API(0x02865950, 0x0, void, il2cpp_set_data_dir, (const char* data_path)); // a1[3]
DO_API(0x028659C0, 0x0, void, il2cpp_set_temp_dir, (const char* temp_path)); // a1[4]
DO_API(0x02865910, 0x0, void, il2cpp_set_commandline_arguments, (int argc, const char* const argv[], const char* basedir)); // a1[5]
DO_API(0x02865940, 0x0, void, il2cpp_set_config_utf16, (const Il2CppChar* executablePath)); // a1[6]
DO_API(0x02865920, 0x0, void, il2cpp_set_config, (const char* executablePath)); // a1[7]
DO_API(0x02865990, 0x0, void, il2cpp_set_memory_callbacks, (Il2CppMemoryCallbacks* callbacks)); // a1[8]
DO_API(0x02865670, 0x0, const Il2CppImage*, il2cpp_get_corlib, ()); // a1[9]
DO_API(0x02864FD0, 0x0, void, il2cpp_add_internal_call, (const char* name, Il2CppMethodPointer method)); // a1[10]
DO_API(0x02865890, 0x0, Il2CppMethodPointer, il2cpp_resolve_icall, (const char* name)); // a1[11]
...
DO_API(0x02865040, 0x0, Il2CppArray*, il2cpp_array_new, (Il2CppClass* elementTypeInfo, il2cpp_array_size_t length)); // a1[17]
...
DO_API(0x02865080, 0x0, const Il2CppImage*, il2cpp_assembly_get_image, (const Il2CppAssembly* assembly)); // a1[22]
...
DO_API(0x028650C0, 0x0, Il2CppClass*, il2cpp_class_from_name, (const Il2CppImage* image, const char* namespaze, const char* name)); // a1[28]
...
DO_API(0x02865340, 0x0, Il2CppDomain*, il2cpp_domain_get, ()); // a1[56]
DO_API(0x02865330, 0x0, const Il2CppAssembly*, il2cpp_domain_assembly_open, (Il2CppDomain* domain, const char* name)); // a1[57]
...
DO_API(0x02865BA0, 0x0, void, il2cpp_format_exception, (const Il2CppException* ex, char* message, int message_size)); // a1[61]
...
DO_API(0x02865810, 0x0, Il2CppObject*, il2cpp_object_new, (const Il2CppClass* klass)); // a1[115]
DO_API(0x02973100, 0x0, Il2CppObject*, il2cpp_value_box, (Il2CppClass* klass, void* data)); // a1[117]
...
DO_API(0x02865A60, 0x0, Il2CppThread*, il2cpp_thread_attach, (Il2CppDomain* domain)); // a1[139]
