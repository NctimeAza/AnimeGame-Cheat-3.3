...
// Show Skill CDs
DO_APP_FUNC(0x02BFF5D0, void, MoleMole_LCAvatarCombat_SetSkillIndex, (LCAvatarCombat* __this, LCAvatarCombat_LCAvatarCombat_SkillInfo* skillInfo, int32_t index, int32_t priority, MethodInfo* method));
DO_APP_FUNC(0x02BF9B60, void, MoleMole_LCAvatarCombat_CheckCDTimer, (LCAvatarCombat* __this, LCAvatarCombat_LCAvatarCombat_SkillInfo* info, MethodInfo* method));
DO_APP_FUNC(0x02BFC110, int32_t, MoleMole_LCAvatarCombat_GetSkillMaxChargesCount, (LCAvatarCombat* __this, uint32_t skillID, MethodInfo* method));
DO_APP_FUNC(0x02BFBB50, int32_t, MoleMole_LCAvatarCombat_GetSkillCurrentChargesCount, (LCAvatarCombat* __this, uint32_t skillID, MethodInfo* method));
DO_APP_FUNC(0x02C00580, float, MoleMole_LCAvatarCombat_GetCurrentSkillCD, (LCAvatarCombat* __this, uint32_t skillID, MethodInfo* method));

DO_APP_FUNC(0x04574440, void, MonoTeamBtn_Update, (MonoTeamBtn* __this, MethodInfo* method));
DO_APP_FUNC(0x04574AD0, void, MonoTeamBtn_set_showPCKey, (MonoTeamBtn* __this, bool value, MethodInfo* method));
DO_APP_FUNC(0x045746A0, void, MonoTeamBtn_set_PCKey, (MonoTeamBtn* __this, String* value, MethodInfo* method));
